 ...
 */
package com.cloudfoundry.samples.spring.config;
...
import com.cloudfoundry.samples.spring.user.SecurityContext;
import com.cloudfoundry.samples.spring.user.SimpleConnectionSignUp;
import com.cloudfoundry.samples.spring.user.SimpleSignInAdapter;
import com.cloudfoundry.samples.spring.user.User;
