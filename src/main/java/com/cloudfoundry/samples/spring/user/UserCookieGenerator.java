 ...
 */
package com.cloudfoundry.samples.spring.user;
...
/**
 * Utility class for managing the cloudfoundry_user cookie that remembers the signed-in user.
 * @author Keith Donald
 */
final class UserCookieGenerator {
	...
	public UserCookieGenerator() {
		userCookieGenerator.setCookieName("cloudfoundry_user");
	}
